...
namespace PrimeiroForms
{
    public partial class appMedia : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (verifica == false)
            {
                MessageBox.Show("Este Formato de valor é inválido na nota 1.");
                return;
            }
            ...
            if (verifica == false)
            {
                MessageBox.Show("Esse Formato de valor inválido é na nota 2.");
                return;
            }
            ...
            if (verifica == false)
            {
                MessageBox.Show("Esse Formato de valor é inválido na nota 3.");
                return;
            }
            ...
            if (verifica == false)
            {
                MessageBox.Show("Esse Formato de valor inválido é na nota 4.");
                return;
            }
